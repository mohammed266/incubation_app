...
class EditChildController {
  //Form Keys
  GlobalKey<FormState> editChildInformationKey = GlobalKey<FormState>();
  GlobalKey<FormState> editAttendanceAndDepartureKey = GlobalKey<FormState>();
  GlobalKey<FormState> editMedicalInformationKey = GlobalKey<FormState>();
  GlobalKey<FormState> editRequiredDocumentsKey = GlobalKey<FormState>();
  ...
  Future editChild(
      {childName,
        ...
        File childMedicalImage,
        context}) async {
    String url = "https://superheroesland.com/wp-json/siteapi/v1/children/12";
  ...
  Future childEditDateImage() async {
    final pickedFile = await picker.getImage(source: ImageSource.gallery);
  ...
  Future childEditVaccinationCardImage() async {
    final pickedFile = await picker.getImage(source: ImageSource.gallery);
  ...
  Future childEditMedicalImage() async {
    final pickedFile = await picker.getImage(source: ImageSource.gallery);
